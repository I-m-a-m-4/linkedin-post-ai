  ...
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
       "group-[.success]:text-green-400 group-[.success]:hover:text-green-600 group-[.success]:focus:ring-green-400 group-[.success]:focus:ring-offset-green-600",
      className
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ...
    className={cn(
      ...
      "group-[.destructive]:text-destructive dark:group-[.destructive]:text-red-400",
      "group-[.success]:text-green-800 dark:group-[.success]:text-green-300",
       className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ...
    className={cn(
        "text-sm opacity-80",
        "group-[.destructive]:text-destructive/80 dark:group-[.destructive]:text-red-400/80",
        "group-[.success]:text-green-700/80 dark:group-[.success]:text-green-400/80",
        className
    )}
    {...props}
  />
