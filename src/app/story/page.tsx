    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 sm:px-6 py-24 md:py-32">
          ...
          <div className="h-[150px] md:h-[170px] my-16 md:my-24 max-w-2xl mx-auto">
            <RetroTv3d />
          </div>

          <div className="space-y-16">
            <StoryText>
              My name is <span className="font-bold text-primary">Imam</span>. I'm a Part 2 Electrical & Electronics Engineering student, a software developer, and a tech enthusiast with a burning ambition: to build the next unicorn startup. To build something that truly solves a problem.
            </StoryText>
      ...
      {/* The footer on the story page doesn't need review functionality */}
